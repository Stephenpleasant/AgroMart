...
const Authbuyer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // TEMPORARY DEBUG MODE - Remove this when your backend is ready
    if (!isRegister) {
      ...
      alert('Login successful! (Debug mode)');
      setIsLoading(false);
      navigate('/dashboard');
      return;
    }
        ...
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {isRegister 
                ? 'Buy your fresh agriculture products' 
          ...
          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded text-xs">
            <p className="text-yellow-800">
              <strong>Debug Mode:</strong> Login without backend - just enter any email/password and click Sign In
            </p>
          </div>
        </div>
